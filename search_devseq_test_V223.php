...
if ($_POST['filter1'] == "Arabidopsis_thaliana") { 
  $colnames = array(['ID','root_root tip_5d.1', 'root_root tip_5d.2', 'root_root tip_5d.3', 'root_maturation zone_5d.1', 'root_maturation zone_5d.2', 'root_whole root_5d.1', 'root_whole root_5d.2', 'root_whole root_5d.3', 'root_maturation zone_5d.3', 'root_whole root_7d.1', 'root_whole root_7d.2', 'root_whole root_7d.3', 'root_whole root_14d.1', 'root_whole root_14d.2', 'root_whole root_14d.3', 'root_whole root_21d.1', 'root_whole root_21d.2', 'root_whole root_21d.3', 'hypocotyl_10d.1', 'hypocotyl_10d.2', 'hypocotyl_10d.3', '3rd internode_24d.1', '3rd internode_24d.2', '3rd internode_24d.3', '2nd internode_24d.1', '2nd internode_24d.2', '2nd internode_24d.3', '1st internode_28d.1', '1st internode_28d.2', '1st internode_28d.3', 'cotyledons_7d.1', 'cotyledons_7d.2', 'cotyledons_7d.3', 'leaf 1+2_7d.1', 'leaf 1+2_7d.2', 'leaf 1+2_7d.3', 'leaf 1+2_10d.1', 'leaf 1+2_10d.2', 'leaf 1+2_10d.3', 'leaf 1+2_petiole_10d.1', 'leaf 1+2_petiole_10d.2', 'leaf 1+2_petiole_10d.3', 'leaf 1+2_leaf tip_10d.1', 'leaf 1+2_leaf tip_10d.2', 'leaf 1+2_leaf tip_10d.3', 'leaf_5+6_17d.1', 'leaf_5+6_17d.2', 'leaf_5+6_17d.3', 'leaf_9+10_27d.1', 'leaf_9+10_27d.2', 'leaf_9+10_27d.3', 'leaves senescing_35d.1', 'leaves senescing_35d.2', 'leaves senescing_35d.3', 'cauline leaves_24d.1', 'cauline leaves_24d.2', 'cauline leaves_24d.3', 'apex vegetative_7d.1', 'apex vegetative_7d.2', 'apex vegetative_7d.3', 'apex vegetative_10d.1', 'apex vegetative_10d.2', 'apex vegetative_10d.3', 'apex vegetative_14d.1', 'apex vegetative_14d.2', 'apex vegetative_14d.3', 'apex inflorescence_21d.1', 'apex inflorescence_21d.2', 'apex inflorescence_21d.3', 'apex inflorescence_28d.1', 'apex inflorescence_28d.2', 'apex inflorescence_28d.3', 'apex inflorescence_clv1_21d.1', 'apex inflorescence_clv1_21d.2', 'apex inflorescence_clv1_21d.3', 'flower stg9_21d+.1', 'flower stg9_21d+.2', 'flower stg9_21d+.3', 'flower stg10/11_21d+.1', 'flower stg10/11_21d+.2', 'flower stg10/11_21d+.3', 'flower stg12_21d+.1', 'flower stg12_21d+.2', 'flower stg12_21d+.3', 'flower stg15_21d+.1', 'flower stg15_21d+.2', 'flower stg15_21d+.3', 'flower stg12_sepals.1', 'flower stg12_sepals.2', 'flower stg12_sepals.3', 'flower stg15_sepals.1', 'flower stg15_sepals.2', 'flower stg15_sepals.3', 'flower stg12_petals.1', 'flower stg12_petals.2', 'flower stg12_petals.3', 'flower stg15_petals.1', 'flower stg15_petals.2', 'flower stg15_petals.3', 'flower stg12_stamens.1', 'flower stg12_stamens.2', 'flower stg12_stamens.3', 'flower stg15_stamens.1', 'flower stg15_stamens.2', 'flower stg15_stamens.3', 'mature pollen_28d+.1', 'mature pollen_28d+.2', 'mature pollen_28d+.3', 'flower early stg12_carpels.1', 'flower early stg12_carpels.2', 'flower early stg12_carpels.3', 'flower late stg12_carpels.1', 'flower late stg12_carpels.2', 'flower late stg12_carpels.3', 'flower stg15_carpels.1', 'flower stg15_carpels.2', 'flower stg15_carpels.3', 'fruit stg16_siliques.1', 'fruit stg16_siliques.2', 'fruit stg16_siliques.3', 'fruit stg17a_siliques.1', 'fruit stg17a_siliques.2', 'fruit stg17a_siliques.3', 'fruit stg16/17a_seeds.1', 'fruit stg16/17a_seeds.2', 'fruit stg16/17a_seeds.3', 'fruit stg17b_seeds.1', 'fruit stg17b_seeds.2', 'fruit stg17b_seeds.3', 'fruit stg18_seeds.1', 'fruit stg18_seeds.2', 'fruit stg18_seeds.3']);
...
$sboxplaceholder = "Enter gene or isoform ID, or symbol, e.g. AT5G10720, AT1G19850.1, PIN1, or paste a list";

// Set input box placeholder in case another species gets selected
if ($_POST['filter1'] == "Arabidopsis_thaliana") {
$sboxplaceholder = "Enter gene or isoform ID, or symbol, e.g. AT5G10720, AT1G19850.1, PIN1, or paste a list";
} else if ($_POST['filter1'] == "Arabidopsis_lyrata") {
$sboxplaceholder = "Enter gene or isoform ID, e.g. AL6G21260.t1, AL1G32580.t1, or paste a list of identifiers";
} else if ($_POST['filter1'] == "Capsella_rubella") {
$sboxplaceholder = "Enter gene or isoform ID, e.g. Carubv10003739m, Carubv10008258m, or paste a list";
} else if ($_POST['filter1'] == "Eutrema_salsugineum") {
$sboxplaceholder = "Enter gene or isoform ID, e.g. Thhalv10012606m, Thhalv10006748m, or paste a list of IDs";
} else if ($_POST['filter1'] == "Tarenaya_hassleriana") {
$sboxplaceholder = "Enter gene or isoform ID, e.g. XM_010527257.2, XM_010538056.2, or paste a list of IDs";
} else if ($_POST['filter1'] == "Medicago_truncatula") {
$sboxplaceholder = "Enter gene or isoform ID, e.g. Medtr1g013360.1, Medtr1g024025.1, or paste a list of IDs";
...
************************************************************************ -->
  ...
  <link rel="stylesheet" href="/CSS/DevSeq_V111.css">
      ...
      <div class = "reqinnercontent">
        ...
        <div class = startsrchctr>
          <form id="devseqform" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
            ...
            <div class="selsearchwrapperstr">
              ...
              <div class="search-form">
                <div class="SBoxsrt">
                  ...
                  <input name="searchquery" type="text" autofocus="autofocus" id="sfqsrt" size="35" maxlength="15000" class="tftextinput2" placeholder= "<?php echo $sboxplaceholder; ?>" value= "<?php if((isset($_POST['searchquery'])) && $_POST['searchquery'] != "") {echo $searchquery;} ?>" />
            ...
            <!-- Format "SBoxsrt" input text and "right-inner-addonsrt" for hover event-->
            <script type="text/javascript"> 
              var fasearchinfo2 = $("#fasearchinfo2_id");
              var sfqsrtid = $("#sfqsrt");
              var rightinneraddonsrtid = $("#rightinneraddonsrt_id");
              var tooltipsrcsrtid = $("#tooltipsrcsrtid");
              sfqsrtid
                .focus(function(){
                  fasearchinfo2
                  .addClass("focus");
              ...
              $(document).ready(function(e){
                sfqsrtid.keyup(function() {
                if ( $(this).val().length > 0 ) {
                  fasearchinfo2.hide()
                  rightinneraddonsrtid.addClass("defocus")
                  tooltipsrcsrtid.hide();
                  }
                else { 
                  fasearchinfo2.show()
                  rightinneraddonsrtid.removeClass("defocus")
                  tooltipsrcsrtid.show();
                  };
                });
              });
            </script>
         ...
         <div class="search-form">
            <div class="SBox">
             <div class="right-inner-addon">
               <input name="searchquery" type="text" id="sfq" size="35" maxlength="15000" class="tftextinput2" placeholder= "<?php echo $sboxplaceholder; ?>" value= "<?php if((isset($_POST['searchquery'])) && $_POST['searchquery'] != "") {echo $searchquery;} ?>" />
              ...
              <div>
                ...
                <div class="some-classundr">
                  <div class = "rsltsrcpargridfst">
                    <div class = rsltsrctitle><b>Expression estimation</b></div>
                    <table></table>
                    <input type="hidden" name="filter5" value="0">
                ...
                ************************************************************************ -->
                ...
                <div class = "dlbtns">
                  <div class = "dlbtncont">
                    ...
                    <button id="show2" class="btn btn-gray-light" title="Generate pdf and download chart from cloud" <?php if ((!isset($_POST['searchquery']) || $_POST['searchquery'] == "") || $count==0 || $_POST['filter4'] == "heatmap" || ($_POST['filter4'] == "heatmap" && $_POST['filter6'] == "1" && $count==1)) {?> style="display: none" <?php } ?> style="text-decoration: none" class="tfbutton4" onclick="return addnsandprint()"><i class="fa fa-cloud-download" aria-hidden="true" style="color:#0a1e38"></i> <span>Chart</span></a></button>
                    </span>
                    ...
                    <span style="display:inline-block; "></span>
                      ...
                      <div class = "lnchartbtns">
                        ...
                        <div class='lchart' id="displaybtngroup" role="group" <?php if ((!isset($_POST['searchquery']) || $_POST['searchquery'] == "") || $count==0){?> style="display: none" <?php } ?> style="text-decoration: none" >
                          ...
                          <button id="displaydomain" class="btn-display active" title="Show domains" <?php if ((!isset($_POST['searchquery']) || $_POST['searchquery'] == "") || $count==0){?> style="display: none" <?php } ?> style="text-decoration: none" onclick="a_function();"><span>Domain</span></button>
                          </span>
                          <span class = 'lchartset2'>
                          <button id="displaygrid" class="btn-display" title="Show grid lines" <?php if ((!isset($_POST['searchquery']) || $_POST['searchquery'] == "") || $count==0){?> style="display: none" <?php } ?> style="text-decoration: none" onclick="b_function();"><span>Grid</span></button>
                          </span>
                          <span class = 'lchartset3'>
                          <button id="displayplain" class="btn-display" title="Display plain chart area" <?php if ((!isset($_POST['searchquery']) || $_POST['searchquery'] == "") || $count==0){?> style="display: none" <?php } ?> style="text-decoration: none" onclick="c_function();"><span>Plain</span></button>
                          </span>
                        </div> 
                        <?php } 
                      ...
                      <div class = "hmapbtns">
                        ...
                        <div class='lchart' id="displaybtngroup" role="group" <?php if ((!isset($_POST['searchquery']) || $_POST['searchquery'] == "") || $count==0){?> style="display: none" <?php } ?> style="text-decoration: none" >
                          ...
                          <button id="displaydomain" class="btn-display active" title="Show viridis colorscale" <?php if ((!isset($_POST['searchquery']) || $_POST['searchquery'] == "") || $count==0){?> style="display: none" <?php } ?> style="text-decoration: none" onclick="f_function();"><span>Vd</span></button>
  		                    ...
  		                    <span class = 'hmapset2'>
                          <button id="displaydomain" class="btn-display" title="Show black-blue-yellow colorscale" <?php if ((!isset($_POST['searchquery']) || $_POST['searchquery'] == "") || $count==0){?> style="display: none" <?php } ?> style="text-decoration: none" onclick="g_function();"><span>BkBuY</span></button>
                          </span>
                          <span class = 'hmapset3'>
                          <button id="displaygrid" class="btn-display" title="Show blue-red colorscale" <?php if ((!isset($_POST['searchquery']) || $_POST['searchquery'] == "") || $count==0){?> style="display: none" <?php } ?> style="text-decoration: none" onclick="h_function();"><span>BuRd</span></button>
                          </span>
                          <span class = 'hmapset4'>
                        ...
                        <div class='lchart' id="displaybtngroup" role="group" <?php if ((!isset($_POST['searchquery']) || $_POST['searchquery'] == "") || $count==0){?> style="display: none" <?php } ?> style="text-decoration: none" >
                          ...
                          <button id="displaygrid" class="btn-display active" title="Show viridis colorscale" <?php if ((!isset($_POST['searchquery']) || $_POST['searchquery'] == "") || $count==0){?> style="display: none" <?php } ?> style="text-decoration: none" onclick="l_function();"><span>Vd</span></button>
  		                    ...
  		                    <span class = 'hmapset8'>
                          <button id="displaydomain" class="btn-display" title="Show black-blue-yellow colorscale" <?php if ((!isset($_POST['searchquery']) || $_POST['searchquery'] == "") || $count==0){?> style="display: none" <?php } ?> style="text-decoration: none" onclick="m_function();"><span>BkBuY</span></button>
                          </span>
                          <span class = 'hmapset9'>
                          <button id="displaygrid" class="btn-display" title="Show blue-red colorscale" <?php if ((!isset($_POST['searchquery']) || $_POST['searchquery'] == "") || $count==0){?> style="display: none" <?php } ?> style="text-decoration: none" onclick="n_function();"><span>BuRd</span></button>
                          </span>
                        ...
                        <div class='lchart' id="displaybtngroup" role="group" <?php if ((!isset($_POST['searchquery']) || $_POST['searchquery'] == "") || $count==0){?> style="display: none" <?php } ?> style="text-decoration: none" >
                          ...
                          <button id="displaydomain" class="btn-display" title="Show black-blue-yellow colorscale" <?php if ((!isset($_POST['searchquery']) || $_POST['searchquery'] == "") || $count==0){?> style="display: none" <?php } ?> style="text-decoration: none" onclick="s_function();"><span>BkBuY</span></button>
                          </span>
                          <span class = 'hmapset15'>
                          <button id="displaygrid" class="btn-display" title="Show blue-red colorscale" <?php if ((!isset($_POST['searchquery']) || $_POST['searchquery'] == "") || $count==0){?> style="display: none" <?php } ?> style="text-decoration: none" onclick="t_function();"><span>BuRd</span></button>
                          </span>
                        ...
                        <div class='lchart' id="displaybtngroup" role="group" <?php if ((!isset($_POST['searchquery']) || $_POST['searchquery'] == "") || $count==0){?> style="display: none" <?php } ?> style="text-decoration: none" >
                          ...
                          <button id="displaydomain" class="btn-display" title="Show black-blue-yellow colorscale" <?php if ((!isset($_POST['searchquery']) || $_POST['searchquery'] == "") || $count==0){?> style="display: none" <?php } ?> style="text-decoration: none" onclick="y_function();"><span>BkBuY</span></button>
                          </span>
                          <span class = 'hmapset21'>
                          <button id="displaygrid" class="btn-display" title="Show blue-red colorscale" <?php if ((!isset($_POST['searchquery']) || $_POST['searchquery'] == "") || $count==0){?> style="display: none" <?php } ?> style="text-decoration: none" onclick="z_function();"><span>BuRd</span></button>
                          </span>
...
if($_POST['filter4'] == "line_chart" && $_POST['filter1'] == "Arabidopsis_thaliana" && ($count > 0)) { ?>
    ...
    <script>
      ...
      var ath_regions = [
        {start: 0, end: 17.5},
        {start: 17.5, end: 29.5, class:'col_5'},
        {start: 29.5, end: 56.5, class: 'col_2', opacity:0.19},
        {start: 56.5, end: 74.5, class:'col_5'},
        {start: 74.5, end: 86.5},
        {start: 86.5, end: 104.5, class:'col_5'},
        {start: 104.5, end: 107.5, class:'col_5'},
        {start: 107.5, end: 113.5, class:'col_5'},
        {start: 113.5, end: 130.75, class: 'col_1', opacity:.14}
      ];
      ...
      var chart = c3.generate({
        ...
        grid: {
          x: {lines: [{value: 131.3, class: 'gridy'}]},
          lines: {front: false},
        },
        zoom: {enabled: false},
        regions: ath_regions
...
else if ($_POST['filter4'] == "line_chart" && ($count > 0) && $_POST['filter1'] != "Arabidopsis_thaliana") { ?>
...
// define heatmap plot parameters for plotting Arabidopsis thaliana data here
    ...
    <script type="text/javascript">
      ...
      Plotly.newPlot('myDiv', [{x: xValues, y: yValues, z: zValues, text: text, hoverinfo: 'text', hoverlabel: {bgcolor: '#41454c'}, layout: layout, colorbar: colorbar, type: 'heatmap', colorscale: 'Viridis'}], layout, config);
      ...
      // Function to call black-blue-yellow plot
      function g_function(){
        $(function () {
        Plotly.newPlot('myDiv',[{x: xValues, y: yValues, z: zValues, text: text, hoverinfo: 'text', hoverlabel: {bgcolor: '#41454c'}, layout: layout, colorbar: colorbar, type: 'heatmap', colorscale: [['0.0', 'rgb(14, 14, 44)'],['0.01', 'rgb(23, 23, 67)'],['0.07', 'rgb(38, 42, 96)'],['0.18', 'rgb(51, 61, 123)'],['0.31', 'rgb(65, 80, 150)'],['0.43', 'rgb(80, 99, 177)'],['0.55', 'rgb(98, 121, 142)'],['0.66', 'rgb(132, 152, 110)'],['0.77', 'rgb( 168, 178, 70)'],['0.88', 'rgb(206, 210, 39)'],['1.0', 'rgb(220, 220, 24)']]}], layout, config);
          }
        )}


      // Function to call blue-red plot
      function h_function(){
        $(function () {
        Plotly.newPlot('myDiv', [{x: xValues, y: yValues, z: zValues, text: text, hoverinfo: 'text', hoverlabel: {bgcolor: '#41454c'}, layout: layout, colorbar: colorbar, type: 'heatmap', colorscale: [['0', 'rgb(0, 0, 158)'],['0.08333333', 'rgb(46, 48, 218)'],['0.1666667', 'rgb(75, 79, 230)'],['0.25', 'rgb(113, 119, 234)'],['0.34', 'rgb(151, 159, 237)'],['0.43', 'rgb(189, 189, 231)'],['0.5', 'rgb(208, 208, 208)'],['0.57', 'rgb(248, 175, 175)'],['0.66', 'rgb(244, 148, 148)'],['0.75', 'rgb(240, 111, 111)'],['0.8333333', 'rgb(236, 74, 74)'],['0.9166667', 'rgb(232, 37, 37)'],['1.0', 'rgb(229, 0, 0)']]}], layout, config);
          }
        )}
      ...
      function i_function(){
        $(function () {
        Plotly.newPlot('myDiv', [{x: xValues, y: yValues, z: zValues, text: text, hoverinfo: 'text', hoverlabel: {bgcolor: '#41454c'}, layout: layout, colorbar: colorbar, type: 'heatmap', colorscale: [['0.0', 'rgb(245, 252, 234)'],['0.11112', 'rgb(232, 243, 203)'],['0.22223', 'rgb(215, 230, 168)'],['0.33334', 'rgb(198, 218, 132)'],['0.44445', 'rgb(183, 206, 97)'],['0.55556', 'rgb(144, 185, 77)'],['0.66667', 'rgb(105, 162, 61)'],['0.77778', 'rgb(67, 138, 45)'],['0.88889', 'rgb(29, 115, 29)'],['1.0', 'rgb(0, 87, 18)']]}], layout, config);
          }
        )}
      ...
      function j_function(){
        $(function () {
        Plotly.newPlot('myDiv',[{x: xValues, y: yValues, z: zValues, text: text, hoverinfo: 'text', hoverlabel: {bgcolor: '#41454c'}, layout: layout, colorbar: colorbar, type: 'heatmap', colorscale: [['0.0', 'rgb(254, 0, 0)'],['0.11', 'rgb(254, 36, 0)'],['0.22', 'rgb(254, 72, 0)'],['0.33', 'rgb(254, 108, 0)'],['0.44', 'rgb(254, 145, 0)'],['0.55', 'rgb(254, 181, 0)'],['0.66', 'rgb(254, 217, 0)'],['0.77', 'rgb(255, 254, 0)'],['0.88', 'rgb(255, 254, 95)'],['1.0', 'rgb(255, 255, 140)']]}], layout, config);
          }
        )}
      ...
      function k_function(){
        $(function () {
        Plotly.newPlot('myDiv',[{x: xValues, y: yValues, z: zValues, text: text, hoverinfo: 'text', hoverlabel: {bgcolor: '#41454c'}, layout: layout, colorbar: colorbar, type: 'heatmap', colorscale: [['0.0', 'rgb(255, 255, 191)'],['0.11111', 'rgb(255, 254, 95)'],['0.22222', 'rgb(255, 254, 0)'],['0.33333', 'rgb(254, 217, 0)'],['0.444444', 'rgb(254, 181, 0)'],['0.555555555556', 'rgb(254, 145, 0)'],['0.666666666667', 'rgb(254, 108, 0)'],['0.777777777778', 'rgb(254, 72, 0)'],['0.888888888889', 'rgb(254, 36, 0)'],['1.0', 'rgb(254, 0, 0)']]}], layout, config);
          }
        )}
...
// define heatmap plot parameters for plotting non-Arabidopsis thaliana data here
    ...
    <script type="text/javascript">
      ...
      // Function to call black-blue-yellow plot for non-Arabidopsis thaliana species
      function s_function(){
        $(function () {
        Plotly.newPlot('myDiv',[{x: xValues, y: yValues, z: zValues, text: text, hoverinfo: 'text', hoverlabel: {bgcolor: '#41454c'}, layout: layout, colorbar: colorbar, type: 'heatmap', colorscale: [['0.0', 'rgb(14, 14, 44)'],['0.01', 'rgb(23, 23, 67)'],['0.07', 'rgb(38, 42, 96)'],['0.18', 'rgb(51, 61, 123)'],['0.31', 'rgb(65, 80, 150)'],['0.43', 'rgb(80, 99, 177)'],['0.55', 'rgb(98, 121, 142)'],['0.66', 'rgb(132, 152, 110)'],['0.77', 'rgb( 168, 178, 70)'],['0.88', 'rgb(206, 210, 39)'],['1.0', 'rgb(220, 220, 24)']]}], layout, config);
          }
      ...
      // Function to call blue-red plot for non-Arabidopsis thaliana species
      function t_function(){
        $(function () {
        Plotly.newPlot('myDiv',[{x: xValues, y: yValues, z: zValues, text: text, hoverinfo: 'text', hoverlabel: {bgcolor: '#41454c'}, layout: layout, colorbar: colorbar, type: 'heatmap', colorscale: [['0', 'rgb(0, 0, 158)'],['0.08333333', 'rgb(46, 48, 218)'],['0.1666667', 'rgb(75, 79, 230)'],['0.25', 'rgb(113, 119, 234)'],['0.34', 'rgb(151, 159, 237)'],['0.43', 'rgb(189, 189, 231)'],['0.5', 'rgb(208, 208, 208)'],['0.57', 'rgb(248, 175, 175)'],['0.66', 'rgb(244, 148, 148)'],['0.75', 'rgb(240, 111, 111)'],['0.8333333', 'rgb(236, 74, 74)'],['0.9166667', 'rgb(232, 37, 37)'],['1.0', 'rgb(229, 0, 0)']]}], layout, config);
          }
...
// define hclust viridis heatmap plot parameters for plotting Arabidopsis thaliana data here
    ...
    function m_function(){
      $(function () {
      Plotly.newPlot('myDiv',[{x: xValues, y: yValues, z: zValues, text: text, hoverinfo: 'text', hoverlabel: {bgcolor: '#41454c'}, layout: layout, colorbar: colorbar, type: 'heatmap', colorscale: [['0.0', 'rgb(11, 11, 40)'],['0.01', 'rgb(17, 17, 59)'],['0.07', 'rgb(31, 36, 86)'],['0.18', 'rgb(45, 55, 113)'],['0.31', 'rgb(59, 74, 140)'],['0.43', 'rgb(74, 93, 167)'],['0.55', 'rgb(91, 114, 132)'],['0.66', 'rgb(129, 146, 101)'],['0.77', 'rgb( 168, 178, 70)'],['0.88', 'rgb(206, 210, 39)'],['1.0', 'rgb(224, 224, 24)']]}], layout, config);
        }
      )}
...
// define hclust heatmap parameters for plotting non-Arabidopsis thaliana data here
    ...
    // Function to call black-blue-yellow hclust heatmap plot for non-Arabidopsis thaliana species 
    function y_function(){
      $(function () {
      Plotly.newPlot('myDiv',[{x: xValues, y: yValues, z: zValues, text: text, hoverinfo: 'text', hoverlabel: {bgcolor: '#41454c'}, layout: layout, colorbar: colorbar, type: 'heatmap', colorscale: [['0.0', 'rgb(14, 14, 44)'],['0.01', 'rgb(23, 23, 67)'],['0.07', 'rgb(38, 42, 96)'],['0.18', 'rgb(51, 61, 123)'],['0.31', 'rgb(65, 80, 150)'],['0.43', 'rgb(80, 99, 177)'],['0.55', 'rgb(98, 121, 142)'],['0.66', 'rgb(132, 152, 110)'],['0.77', 'rgb( 168, 178, 70)'],['0.88', 'rgb(206, 210, 39)'],['1.0', 'rgb(220, 220, 24)']]}], layout, config);
        }
    ...
    // Function to call blue-red hclust heatmap plot for non-Arabidopsis thaliana species 
    function z_function(){
      $(function () {
      Plotly.newPlot('myDiv',[{x: xValues, y: yValues, z: zValues, text: text, hoverinfo: 'text', hoverlabel: {bgcolor: '#41454c'}, layout: layout, colorbar: colorbar, type: 'heatmap', colorscale: [['0', 'rgb(0, 0, 158)'],['0.08333333', 'rgb(46, 48, 218)'],['0.1666667', 'rgb(75, 79, 230)'],['0.25', 'rgb(113, 119, 234)'],['0.34', 'rgb(151, 159, 237)'],['0.43', 'rgb(189, 189, 231)'],['0.5', 'rgb(208, 208, 208)'],['0.57', 'rgb(248, 175, 175)'],['0.66', 'rgb(244, 148, 148)'],['0.75', 'rgb(240, 111, 111)'],['0.8333333', 'rgb(236, 74, 74)'],['0.9166667', 'rgb(232, 37, 37)'],['1.0', 'rgb(229, 0, 0)']]}], layout, config);
        }
...
************************************************************************ -->
  ...
  <!-- Spinner for heatmap css2pdf download -->
  <script type="text/javascript">
    $(document).ready(function () {
     $("#show").click(function() {
