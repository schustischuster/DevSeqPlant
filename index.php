...
if (isset($_POST['searchquery']) && $_POST['searchquery'] != "") {
  ...
  $alcolnames .= 'root_whole_root_6d_1, root_whole_root_6d_2, root_whole_root_6d_3,  hypocotyl_12d_1, hypocotyl_12d_2, hypocotyl_12d_3, leaf_1_2_10d_1, leaf_1_2_10d_2, leaf_1_2_10d_3, apex_vegetative_11d_1, apex_vegetative_11d_2, apex_vegetative_11d_3, apex_inflorescence_20w_1, apex_inflorescence_20w_2, apex_inflorescence_20w_3, flower_stg12_20w_1, flower_stg12_20w_2, flower_stg12_20w_3, flower_stamen_stg11_21w_1, flower_stamen_stg11_21w_2, flower_stamen_stg11_21w_3, flower_stamen_early_stg12_21w_1, flower_stamen_early_stg12_21w_2, flower_stamen_early_stg12_21w_3, flower_stamen_mid_stg12_21w_1, flower_stamen_mid_stg12_21w_2, flower_stamen_mid_stg12_21w_3, flower_stamen_late_stg12_21w_1, flower_stamen_late_stg12_21w_2, flower_stamen_late_stg12_21w_3, flower_mature_pollen_21w_1, flower_mature_pollen_21w_2, flower_mature_pollen_21w_3, flower_carpel_20w_1, flower_carpel_20w_2, flower_carpel_20w_3';

  $crcolnames .= 'root_whole_root_4d_1, root_whole_root_4d_2, root_whole_root_4d_3,  hypocotyl_9d_1, hypocotyl_9d_2, hypocotyl_9d_3, leaf_1_2_7d_1, leaf_1_2_7d_2, leaf_1_2_7d_3, apex_vegetative_7d_1, apex_vegetative_7d_2, apex_vegetative_7d_3, apex_inflorescence_15w_1, apex_inflorescence_15w_2, apex_inflorescence_15w_3, flower_stg12_16w_1, flower_stg12_16w_2, flower_stg12_16w_3, flower_stamen_stg12_16w_1, flower_stamen_stg12_16w_2, flower_stamen_stg12_16w_3, flower_mature_pollen_16w_1, flower_mature_pollen_16w_2, flower_mature_pollen_16w_3, flower_carpel_16w_1, flower_carpel_16w_2, flower_carpel_16w_3';

  $escolnames .= 'root_whole_root_6d_1, root_whole_root_6d_2, root_whole_root_6d_3,  hypocotyl_12d_1, hypocotyl_12d_2, hypocotyl_12d_3, leaf_1_2_9d_1, leaf_1_2_9d_2, leaf_1_2_9d_3, apex_vegetative_9d_1, apex_vegetative_9d_2, apex_vegetative_9d_3, apex_inflorescence_17w_1, apex_inflorescence_17w_2, apex_inflorescence_17w_3, flower_stg12_17w_1, flower_stg12_17w_2, flower_stg12_17w_3, flower_stamen_stg12_17w_1, flower_stamen_stg12_17w_2, flower_stamen_stg12_17w_3, flower_mature_pollen_17w_1, flower_mature_pollen_17w_2, flower_mature_pollen_17w_3, flower_carpel_18w_1, flower_carpel_18w_2, flower_carpel_18w_3';
  ...
  } else if ($_POST['filter1'] == "Brachypodium_distachyon" && $_POST['filter2'] == "gene_level" && ($_POST['filter5'] == "0" || $_POST['filter5'] == "1")) {
    $sqlCommand = "SELECT gene_id, {$bdcolnames} FROM Brachypodium_distachyon_gene_tpm_20231121 WHERE gene_id in ('".implode("','",$search)."')";
  
  } else if ($_POST['filter1'] == "Brachypodium_distachyon" && $_POST['filter2'] == "gene_level" && ($_POST['filter5'] == "2")) {
    $sqlCommand = "SELECT gene_id, {$bdcolnames} FROM Brachypodium_distachyon_gene_tpm_RE_20231121 WHERE gene_id in ('".implode("','",$search)."')";

  } else if ($_POST['filter1'] == "Brachypodium_distachyon" && $_POST['filter2'] == "isoform_level" && ($_POST['filter5'] == "0" || $_POST['filter5'] == "1")) {
    $sqlCommand = "SELECT transcript_id, {$bdcolnames} FROM Brachypodium_distachyon_transcript_tpm_20231121 WHERE transcript_id in ('".implode("','",$search)."') OR gene_id in ('".implode("','",$search)."')";
  ...
  } else if ($_POST['filter1'] == "Arabidopsis_lyrata" && $_POST['filter2'] == "gene_level" && ($_POST['filter5'] == "0" || $_POST['filter5'] == "1")) {
    $sqlCommand = "SELECT gene_id, {$alcolnames} FROM Arabidopsis_lyrata_gene_tpm_20240827 WHERE gene_id in ('".implode("','",$search)."')";
  
  } else if ($_POST['filter1'] == "Arabidopsis_lyrata" && $_POST['filter2'] == "gene_level" && ($_POST['filter5'] == "2")) {
    $sqlCommand = "SELECT gene_id, {$alcolnames} FROM Arabidopsis_lyrata_gene_tpm_RE_20240827 WHERE gene_id in ('".implode("','",$search)."')";

  } else if ($_POST['filter1'] == "Arabidopsis_lyrata" && $_POST['filter2'] == "isoform_level" && ($_POST['filter5'] == "0" || $_POST['filter5'] == "1")) {
    $sqlCommand = "SELECT transcript_id, {$alcolnames} FROM Arabidopsis_lyrata_transcript_tpm_20240827 WHERE transcript_id in ('".implode("','",$search)."') OR gene_id in ('".implode("','",$search)."')";

  } else if ($_POST['filter1'] == "Arabidopsis_lyrata" && $_POST['filter2'] == "isoform_level" && ($_POST['filter5'] == "2")) {
    $sqlCommand = "SELECT transcript_id, {$alcolnames} FROM Arabidopsis_lyrata_transcript_tpm_RE_20240827 WHERE transcript_id in ('".implode("','",$search)."') OR gene_id in ('".implode("','",$search)."')";

  } else if ($_POST['filter1'] == "Capsella_rubella" && $_POST['filter2'] == "gene_level" && ($_POST['filter5'] == "0" || $_POST['filter5'] == "1")) {
    $sqlCommand = "SELECT gene_id, {$crcolnames} FROM Capsella_rubella_gene_tpm_20240902 WHERE gene_id in ('".implode("','",$search)."')";
  
  } else if ($_POST['filter1'] == "Capsella_rubella" && $_POST['filter2'] == "gene_level" && ($_POST['filter5'] == "2")) {
    $sqlCommand = "SELECT gene_id, {$crcolnames} FROM Capsella_rubella_gene_tpm_RE_20240902 WHERE gene_id in ('".implode("','",$search)."')";

  } else if ($_POST['filter1'] == "Capsella_rubella" && $_POST['filter2'] == "isoform_level" && ($_POST['filter5'] == "0" || $_POST['filter5'] == "1")) {
    $sqlCommand = "SELECT transcript_id, {$crcolnames} FROM Capsella_rubella_transcript_tpm_20240902 WHERE transcript_id in ('".implode("','",$search)."') OR gene_id in ('".implode("','",$search)."')";
...
if ($_POST['filter1'] == "Arabidopsis_thaliana" && ($count < 1251)) { 
  ...
  $colnames = array(['ID','root_whole root_6d.1', 'root_whole root_6d.2', 'root_whole root_6d.3', 'hypocotyl_12d.1', 'hypocotyl_12d.2', 'hypocotyl_12d.3', 'leaf 1+2_10d.1', 'leaf 1+2_10d.2', 'leaf 1+2_10d.3', 'apex vegetative_11d.1', 'apex vegetative_11d.2', 'apex vegetative_11d.3', 'apex inflorescence.1', 'apex inflorescence.2', 'apex inflorescence.3', 'flower stg12.1', 'flower stg12.2', 'flower stg12.3', 'flower stg11_stamens.1', 'flower stg11_stamens.2', 'flower stg11_stamens.3', 'flower early stg12_stamens.1', 'flower early stg12_stamens.2', 'flower early stg12_stamens.2', 'flower mid stg12_stamens.1', 'flower mid stg12_stamens.2', 'flower mid stg12_stamens.3', 'flower late stg12_stamens.1', 'flower late stg12_stamens.2', 'flower late stg12_stamens.3', 'mature pollen.1', 'mature pollen.2', 'mature pollen.3', 'flower stg12_carpels.1', 'flower stg12_carpels.2', 'flower stg12_carpels.3']);
           ...
           <div class="Mega_menu_Content">
            ...
            <div class = "Mega_Menu_Lowerspacer">
              ...
              <div class = "Mega_Menu_LowerspacerTxt">
                <!-- child num1 -->
                <div class="childmmf MMnum1"><a href="index.php" title="Go to Home" ><font color="#717577">DevSeq</font></a><font color="#717577">&nbsp/</font>&nbspData Analysis
                </div>
                <!-- child num3 -->
...
// define line chart parameters for plotting non-Arabidopsis thaliana data here
    ...
    <script>
      ...
      var xValues = 
       <?php if($_POST['filter1'] == "Arabidopsis_lyrata") { ?>
       ['root, whole root, 6d.1', 'root, whole root, 6d.2', 'root, whole root, 6d.3', 'hypocotyl, 12d.1', 'hypocotyl, 12d.2', 'hypocotyl, 12d.3', 'leaf 1+2, 10d.1', 'leaf 1+2, 10d.2', 'leaf 1+2, 10d.3', 'apex vegetative, 11d.1', 'apex vegetative, 11d.2', 'apex vegetative, 11d.3', 'apex inflorescence.1', 'apex inflorescence.2', 'apex inflorescence.3', 'flower stg12.1', 'flower stg12.2', 'flower stg12.3', 'flower stg11, stamen.1', 'flower stg11, stamen.2', 'flower stg11, stamen.3', 'flower early stg12, stamen.1', 'flower early stg12, stamen.2', 'flower early stg12, stamen.3', 'flower mid stg12, stamen.1', 'flower mid stg12, stamen.2', 'flower mid stg12, stamen.3', 'flower late stg12, stamen.1', 'flower late stg12, stamen.2', 'flower late stg12, stamen.3', 'mature pollen.1', 'mature pollen.2', 'mature pollen.3', 'flower stg12, carpels.1', 'flower stg12, carpels.2', 'flower stg12, carpels.3'];
        <?php }
        else if($_POST['filter1'] == "Capsella_rubella") { ?>
       ['root, whole root, 4d.1', 'root, whole root, 4d.2', 'root, whole root, 4d.3', 'hypocotyl, 9d.1', 'hypocotyl, 9d.2', 'hypocotyl, 9d.3', 'leaf 1+2, 7d.1', 'leaf 1+2, 7d.2', 'leaf 1+2, 7d.3', 'apex vegetative, 7d.1', 'apex vegetative, 7d.2', 'apex vegetative, 7d.3', 'apex inflorescence.1', 'apex inflorescence.2', 'apex inflorescence.3', 'flower stg12.1', 'flower stg12.2', 'flower stg12.3', 'flower stg12, stamens.1', 'flower stg12, stamens.2', 'flower stg12, stamens.3', 'mature pollen.1', 'mature pollen.2', 'mature pollen.3', 'flower stg12, carpels.1', 'flower stg12, carpels.2', 'flower stg12, carpels.3'];
        <?php } 
        else if ($_POST['filter1'] == "Eutrema_salsugineum") { ?>
        ['root, whole root, 6d.1', 'root, whole root, 6d.2', 'root, whole root, 6d.3', 'hypocotyl, 12d.1', 'hypocotyl, 12d.2', 'hypocotyl, 12d.3', 'leaf 1+2, 9d.1', 'leaf 1+2, 9d.2', 'leaf 1+2, 9d.3', 'apex vegetative, 9d.1', 'apex vegetative, 9d.2', 'apex vegetative, 9d.3', 'apex inflorescence.1', 'apex inflorescence.2', 'apex inflorescence.3', 'flower stg12.1', 'flower stg12.2', 'flower stg12.3', 'flower stg12, stamens.1', 'flower stg12, stamens.2', 'flower stg12, stamens.3', 'mature pollen.1', 'mature pollen.2', 'mature pollen.3', 'flower stg12, carpels.1', 'flower stg12, carpels.2', 'flower stg12, carpels.3'];
        <?php } 
        else if ($_POST['filter1'] == "Medicago_truncatula") { ?>
        ['root_whole root_4d.1', 'root_whole root_4d.2', 'root_whole root_4d.3', 'hypocotyl_8d.1', 'hypocotyl_8d.2', 'hypocotyl_8d.3', 'leaf 2_7d.1', 'leaf 2_7d.2', 'leaf 2_7d.3', 'apex vegetative_6d.1', 'apex vegetative_6d.2', 'apex vegetative_6d.3', 'meristem inflorescence.1', 'meristem inflorescence.2', 'meristem inflorescence.3', 'flower stg8.1', 'flower stg8.2', 'flower stg8.3', 'flower stg8_stamens.1', 'flower stg8_stamens.2', 'flower stg8_stamens.3', 'mature pollen.1', 'mature pollen.2', 'mature pollen.3', 'flower stg8_carpels.1', 'flower stg8_carpels.2', 'flower stg8_carpels.3'];
        <?php }
        else if ($_POST['filter1'] == "Brachypodium_distachyon") { ?>
...
// define heatmap plot parameters for plotting non-Arabidopsis thaliana data here
    ...
    <script type="text/javascript">
        ...
        ['root, whole root, 4d.1', 'root, whole root, 4d.2', 'root, whole root, 4d.3', 'hypocotyl, 8d.1', 'hypocotyl, 8d.2', 'hypocotyl, 8d.3', 'leaf 2, 7d.1', 'leaf 2, 7d.2', 'leaf 2, 7d.3', 'apex vegetative, 6d.1', 'apex vegetative, 6d.2', 'apex vegetative, 6d.3', 'meristem inflorescence.1', 'meristem inflorescence.2', 'meristem inflorescence.3', 'flower stg8.1', 'flower stg8.2', 'flower stg8.3', 'flower stg8, stamens.1', 'flower stg8, stamens.2', 'flower stg8, stamens.3', 'mature pollen.1', 'mature pollen.2', 'mature pollen.3', 'flower stg8, carpels.1', 'flower stg8, carpels.2', 'flower stg8, carpels.3'];
        <?php }
        else if ($_POST['filter1'] == "Brachypodium_distachyon") { ?>
        ['root_whole root_4d.1', 'root_whole root_4d.2', 'root_whole root_4d.3', 'mesocotyl_7d.1', 'mesocotyl_7d.2', 'mesocotyl_7d.3', 'leaf 1_4d.1', 'leaf 1_4d.2', 'leaf 1_4d.3', 'apex vegetative_5d.1', 'apex vegetative_5d.2', 'apex vegetative_5d.3', 'lateral spikelet meristem.1', 'lateral spikelet meristem.2', 'lateral spikelet meristem.3', 'floret.1', 'floret.2', 'floret.3', 'floret stamens.1', 'floret stamens.2', 'floret stamens.3', 'mature pollen.1', 'mature pollen.2', 'mature pollen.3', 'floret carpels.1', 'floret carpels.2', 'floret carpels.3'];
        <?php }
...
<div class="footer"> 
  <div class="footerinner"> 
    <div class="parent"> 
      <div class="child num1"><a href="index.php"><font color="#1f1fab">Home</font></a>&nbsp · &nbsp<a href="about.html"><font color="#1f1fab">About DevSeq</font></a>&nbsp · &nbsp<a href="contact.html"><font color="#1f1fab">Contact</font></a>
      </div>
      <div class="child num3"><font color="#1f1fab">v1 - June 2024</font>&nbsp · &nbsp<a href="#"><font color="#1f1fab">Back to top<span class="fa fa-chevron-up"><svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512"><path d="M233.4 105.4c12.5-12.5 32.8-12.5 45.3 0l192 192c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L256 173.3 86.6 342.6c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3l192-192z"/></svg></span></a>
      </div>  
    </div> 
  </div> 
</div>
