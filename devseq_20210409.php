...
require_once "connect_to_mysql_devseq_test.php";
    ...
    $("#show3").click(function() {
      ...
      if ($("#displaydomain").hasClass("active")) {
        var chart_2 = c3.generate({
          ...
          regions: ath_regions,
          onrendered: function() {
            d3.select("#chart_2").selectAll(".c3-axis-x .tick line").style("stroke-width", "17px");
            d3.select("#chart_2").selectAll(".c3-axis-x .tick line").style("stroke", "white");
            d3.select("#chart_2").selectAll(".c3-chart-lines").style("display", "inline");
          }   
        });
      }
        ...
        var chart_2 = c3.generate({
          ...
          zoom: {enabled: false},
          onrendered: function() {
            d3.select("#chart_2").selectAll(".c3-axis-x .tick line").style("stroke-width", "10px");
            d3.select("#chart_2").selectAll(".c3-axis-x .tick line").style("stroke", "white");
            d3.select("#chart_2").selectAll(".c3-chart-lines").style("display", "inline");
          }   
        });
    ...
    $("#show4").click(function() {
      ...
      if ($("#displaygrid_noath").hasClass("active")) {
        ...
        var chart_3 = c3.generate({
          ...
          zoom: {enabled: false},
          onrendered: function() {
            d3.select("#chart_3").selectAll(".c3-axis-x .tick line").style("stroke-width", "25px");
            d3.select("#chart_3").selectAll(".c3-axis-x .tick line").style("stroke", "white");
            d3.select("#chart_3").selectAll(".c3-chart-lines").style("display", "inline");
          }   
        });
      }
    })
