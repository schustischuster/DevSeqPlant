...
devseq_replicate_samples_RE <- getRE(devseq_replicate_samples)
...
write.table(devseq_replicate_samples_RE, file="devseq_replicate_samples_RE.csv", sep=";", dec=".", row.names=FALSE, col.names=TRUE)
